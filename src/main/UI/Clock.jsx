...
const Clock = () => {
    ...
    const countDown =()=>{
        ...
        interval =setInterval(()=>{
            ...
            const hour =Math.floor(during % (1000*60*60*24) / (1000*60*60) )
  ...
  return (
    <div className="clock_wrapper flex align-items-center text-center gap-5 m-2 flex-1">
       <div className="clock_data flex align-items-center gap-5">
            <div>
