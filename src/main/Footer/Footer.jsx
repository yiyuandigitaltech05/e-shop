        ...
        <Row>
          <Col lg="4">
            <div className="logo justify-start">
              <div>
                <h5 className="LogoName text-white">Multimart</h5>
              </div>
            </div>
          ...
          <Col lg="3">
            <div className="footer_quick-links">
              <h4 className="quick_links-title text-white">Top</h4>
            ...
            <div className="footer_quick-links">
                <h4 className="quick_links-title text-white">Contact</h4>
                    <ListGroup className="mt-2">
                      ...
                      <p>Guandong Rd., East Dist., Hsinchu City 30072 , Taiwan (R.O.C.)</p>
                      </ListGroupItem>
                      <ListGroupItem className="border-0 ps-0 flex justify-start align-items-start gap-2">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
          ...
          <Col lg='12'>
              <p className="footer_declare">本網站僅供學習、展示之用。 此作品僅為練習及創作之用，無其他商業用途，如果作品有冒犯到任何智慧財產權，請聯繫jimmy36901@gmail.com，會盡速撤銷作品。<br/>
                  This work is only for practicing and creation, and has no other commercial purposes. If the work violates any intellectual property rights, please contact jimmy36901@gmail.com, and the work will be withdrawn as soon as possible</p>
          </Col>
        </Row>
      </Container>
    </footer>
